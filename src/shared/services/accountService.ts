import { Account } from '@/features/account-management/hooks/useAccounts';
...
export const accountService = {
  ...
  async getTotalBalance(userId: string): Promise<number> {
    const accounts: Account[] = await this.listAccounts(userId);
    console.log("🚀 ~ AccountService ~ getTotalBalance ~ accounts:", accounts)
